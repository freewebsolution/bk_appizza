@extends('layouts.app')
@section('title','Create Insalatona')
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">{{ __('Inserisci la Insalatona') }}</div>
                    ...
                    <div class="card-body">
                        <form method="post" enctype="multipart/form-data">
                            ...
                            <div class="container col-md-6">
                                ...
                                <div  class="image-upload"><img id="frame" src="" class="img-fluid" /></div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-12">
                                    <input type="number" id="prezzo" class="form-control" name="prezzo" step="any">
                                </div>
                            </div>
                            ...
                            <div class="form-check mt-2 mb-2">
                                ...
                                <div class="col-lg-12">
                                    <input type="checkbox" class="form-check-input" id="inevidenza" name="inevidenza" value="1">
                            ...
                            <div class="form-group mt-3 mb-3">
                                <div class="col-lg-12 col-lg-offset-2">
                                    ...
                                    <a class="btn btn-danger float-end" href="{{ URL::previous() }}"><i class="fa-solid fa-backward"></i></a>
                                </div>
                            </div>
                        </form>
