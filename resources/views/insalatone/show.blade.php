@extends('layouts.app')
@section('title', 'Insalatona: '.$insalatona->titolo)
@section('content')

    <div class="container col-md-10 col-md-offset-2">
        <div class="card mt-5">
            <div class="card-body">
                <h2 class="header">{{ $insalatona->titolo }}</h2>
                <p> {{ $insalatona->descrizione }} </p>
            </div>
            ...
            <div class="card-body">
                @if($commenti->isEmpty() || !$auth)
                    <form method="post" action="/admin/comment">
                        ...
                        <input type="hidden" name="insalatona_id" value="{{ $insalatona->id }}">
                        <input type="hidden" name="insalatona_type" value="App\insalatona">
                        <div class="form-group">
                ...
                <div class="form-group mt-3 mb-3">
                    <div class="col-lg-12 col-lg-offset-2">
                        <a class="btn btn-danger float-end" href="/admin/insalatone"><i
